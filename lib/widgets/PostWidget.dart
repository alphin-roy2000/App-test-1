...
class Post extends StatefulWidget {
  ...
  Post({this.postId,this.ownerId,this.likes,this.username,this.description,this.location,this.url});
...
class _PostState extends State<Post> {
  ...
  createPostHead(){
    return FutureBuilder(future:  usersReference.document(ownerId).get(),
